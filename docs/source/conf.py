...
latex_documents = [
  ('index', 'BigJob.tex', 'BigJob Manual',
   'The SAGA Project', 'manual'),
]
...
man_pages = [
    ('index', 'BigJob', 'BigJob User Manual',
     ['The SAGA Project'], 1)
]
...
texinfo_documents = [
  ('index', 'BigJob', 'BigJob Manual',
   'The BigJob Project', 'BigJob', 'One line description of project.',
   'Miscellaneous'),
]
